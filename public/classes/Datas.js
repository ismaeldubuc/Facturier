export class Datas {
    ...
    htmlFormat() {
        ...
        <div class="col-md-6 text-right">
            <p class="font-weight-bold mb-1">${this.documentType === "invoice" ? "Facture" : "Devis"}<span class="font-weight-normal">Numéro : ${Math.floor(Math.random() * 101)}</span></p>
    ...
    <div class="row pb-5 p-5">
        ...
        <div class="col-sm-6 text-right">
            ...
            <p class="mb-1">Mr/Mme ${this.firstName} ${this.firstName}/p>
